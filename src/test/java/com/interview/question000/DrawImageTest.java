...
public class DrawImageTest {
    ...
    public void drawWordImageTest() throws IOException {
        drawImage.drawWordInImage(INPUT_IMAGE_PATH + "icon.jpg", "2", "jpg", INPUT_IMAGE_PATH + "icon_new.jpg");
        drawImage.drawWordInImage(INPUT_IMAGE_PATH + "icon1.jpg", "2", "jpg", INPUT_IMAGE_PATH + "icon1_new.jpg");
    }
